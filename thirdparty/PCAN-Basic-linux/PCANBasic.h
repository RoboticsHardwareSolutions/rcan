...
#define PCAN_PEAKCAN                 0x01U  // PCAN Non-Plug&Play devices. NOT USED WITHIN PCAN-Basic-linux API
...
#define PCAN_VIRTUAL                 0x07U  // PCAN Virtual hardware. NOT USED WITHIN PCAN-Basic-linux API
...
#define PCAN_API_VERSION             0x05U  // PCAN-Basic-linux API version parameter
...
#define LOG_FUNCTION_ENTRY           0x01U    // Logs the entries to the PCAN-Basic-linux API functions
#define LOG_FUNCTION_PARAMETERS      0x02U    // Logs the parameters passed to the PCAN-Basic-linux API functions
#define LOG_FUNCTION_LEAVE           0x04U    // Logs the exits from the PCAN-Basic-linux API functions
...
#define LOG_FUNCTION_ALL             0xFFFFU  // Logs all possible information within the PCAN-Basic-linux API functions
...
////////////////////////////////////////////////////////////
// PCAN-Basic-linux API function declarations
////////////////////////////////////////////////////////////
