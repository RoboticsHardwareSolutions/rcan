...
void test_hardware_macos_start_stop_pcan(void)
{
    rcan pcan1 = {0}, pcan2 = {0};
    runit_true(rcan_start(&pcan1, PEAK_CAN_USBBUS1, 1000000));
    runit_true(rcan_start(&pcan2, PEAK_CAN_USBBUS2, 500000));
    runit_true(rcan_stop(&pcan1));
    runit_true(rcan_stop(&pcan2));
}

void test_hardware_macos_start_stop_pcan_twice(void)
{
    rcan pcan1 = {0};
    runit_true(rcan_start(&pcan1, PEAK_CAN_USBBUS1, PCAN_BAUD_100K));
    runit_false(rcan_start(&pcan1, PEAK_CAN_USBBUS2, PCAN_BAUD_100K));
    runit_true(rcan_stop(&pcan1));
    runit_false(rcan_stop(&pcan1));
}

void test_hardware_macos_invalid_arg(void)
{
    rcan pcan1 = {0};
    runit_false(rcan_start(NULL, PEAK_CAN_USBBUS1, 0));
    runit_false(rcan_start(&pcan1, PEAK_CAN_USBBUS2, 4359843));
    runit_false(rcan_start(&pcan1, 0, 0));
    runit_false(rcan_start(&pcan1, 495868907U, PCAN_BAUD_100K));
    runit_false(rcan_stop(NULL));
}

void test_hardware_macos_send_std_frame(void)
{
    rcan       pcan1 = {0}, pcan2 = {0};
    ...
    runit_true(rcan_start(&pcan1, PEAK_CAN_USBBUS1, PCAN_BAUD_10K));
...
void test_hardware_macos_send_ext_frame(void)
{
    rcan       pcan1 = {0}, pcan2 = {0};
    ...
    runit_true(rcan_start(&pcan1, PEAK_CAN_USBBUS1, 125000));
...
void test_hardware_macos_send_rtr_frame(void)
{
    rcan       pcan1 = {0}, pcan2 = {0};
    rcan_frame frame_sended = {0}, frame_received = {0};
...
void test_hardware_macos_send_ext_rtr_frame(void)
{
    rcan       pcan1 = {0}, pcan2 = {0};
    rcan_frame frame_sended = {0}, frame_received = {0};
    ...
    runit_true(rcan_start(&pcan1, PEAK_CAN_USBBUS1, 500000));
    runit_true(rcan_start(&pcan2, PEAK_CAN_USBBUS2, 500000));
    runit_true(rcan_send(&pcan1, &frame_sended));
    while (!rcan_receive(&pcan2, &frame_received))
    {
...
void test_hardware_macos_send_invalid(void)
{
    rcan       pcan1                                = {0};
    uint8_t    payload[RCAN_MAX_FRAME_PAYLOAD_SIZE] = {0, 1, 2, 3, 4, 5, 6, 7};
...
void test_hardware_macos(void)
{
    printf("test hardware macos\n");
    test_hardware_macos_start_stop_pcan();
    test_hardware_macos_start_stop_pcan_twice();
    test_hardware_macos_invalid_arg();
    test_hardware_macos_send_std_frame();
    test_hardware_macos_send_ext_frame();
    test_hardware_macos_send_rtr_frame();
    test_hardware_macos_send_ext_rtr_frame();
    test_hardware_macos_send_invalid();
}
