...
TEST_CASE("virtual can")
{
    ...
    SECTION("send frames")
    {
        SECTION("send std frame vcan0")
        {
            ...
            REQUIRE(rcan_start(&vcan0, SOCKET_VCAN0, 0) == true);
        ...
        SECTION("send extended frame vcan1")
        {
            ...
            REQUIRE(rcan_start(&vcan1, SOCKET_VCAN1, 0) == true);
        ...
        SECTION("send std rtr frame vcan2")
        {
            ...
            REQUIRE(rcan_start(&vcan2, SOCKET_VCAN2, 0) == true);
    ...
    SECTION("receive frames")
    {
        SECTION("receive nonblock test ")
        {
            ...
            rcan_start(&vcan0, SOCKET_VCAN0, 0);
            system("cansend vcan0 5A1#11.2233.44556677.88");
            while (!rcan_receive(&vcan0, &frame_sended))
            {}
        }
